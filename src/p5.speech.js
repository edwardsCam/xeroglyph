 ...
 * @constructor
 */
export function Speech(_dv, _callback) {
  //
...
Speech.prototype.setVoice = function (_v) {
...
Speech.prototype.setVolume = function (_v) {
...
Speech.prototype.setRate = function (_v) {
...
// not working...
Speech.prototype.resume = function () {
  this.synth.resume()
}
...
Speech.prototype.cancel = function () {
  this.synth.cancel() // KILL SYNTH
}

// Setting callbacks with functions instead
Speech.prototype.started = function (_cb) {
  this.onStart = _cb
}

Speech.prototype.ended = function (_cb) {
  this.onEnd = _cb
}

Speech.prototype.paused = function (_cb) {
  this.onPause = _cb
}

Speech.prototype.resumed = function (_cb) {
  this.onResume = _cb
}
 ...
 * @constructor
 */
export function SpeechRec(_lang, _callback) {
  //
...
SpeechRec.prototype.start = function (_continuous, _interim) {
  if ('webkitSpeechRecognition' in window) {
